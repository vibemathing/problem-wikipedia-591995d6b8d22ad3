...
```json
{
  ...
  "problem_contract": {
    ...
    "aliases": [
      "wikipedia:wikipedia-591995d6b8d22ad3"
    ],
    "allowed_axioms": [
    ...
    "domain": {
      "description": "Draft source observation in Graph theory, Graph drawing and embedding; domain extraction is unresolved.",
      "objects": [
    ...
    "problem_id": "problem:wikipedia-591995d6b8d22ad3",
    "quantifiers": [
      {
    ...
    "sources": [
      {
        ...
        "source_record_id": "wikipedia-591995d6b8d22ad3",
        "url": "https://en.wikipedia.org/wiki/Tur%C3%A1n%27s_brick_factory_problem"
      }
    ],
    "statement": {
      "language": "en",
      "text": "Turán's brick factory problem – Is there a drawing of any complete bipartite graph with fewer crossings than the number given by Zarankiewicz?",
      "version": 1
    },
    "title": "Turán's brick factory problem",
    "updated_at": "2026-09-15T21:28:00.195364Z"
  },
  "problem_contract_sha256": "255746f7091fdfd780993a96a064cc592fef4ad8db1b68d9f1ee4174bbcebb4c"
}
```
